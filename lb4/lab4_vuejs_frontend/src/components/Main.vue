                  ...
                  <td>
                    <div id="svg-picture">
                      <svg id="svg" width="386" height="386" xmlns="http://www.w3.org/2000/svg" @click="clickOnSVG">
                        ...
                        <text class="svg-text" font-size="15" x="204" y="48">{{-param_r*-1}}</text>
                        <text class="svg-text" font-size="15" x="204" y="128">{{param_r/2}}</text>
                        <text class="svg-text" font-size="15" x="204" y="268">{{-param_r/2}}</text>
                        <text class="svg-text" font-size="15" x="204" y="338">{{-param_r}}</text>
                        <text class="svg-text" font-size="15" x="335" y="177">{{-param_r*-1}}</text>
                        <text class="svg-text" font-size="15" x="250" y="177">{{param_r/2}}</text>
                        <text class="svg-text" font-size="15" x="105" y="177">{{-param_r/2}}</text>
                        <text class="svg-text" font-size="15" x="22" y="177">{{-param_r}}</text>
                      </svg>
                    </div>
                  </td>
                  <td colspan="2">
      ...
      if (this.data.length !== 0) {
        for (let i = 0; i < this.data.length; i++) {
          ...
          if (!isNaN(x) && !isNaN(y)) {
            ...
            flagForColor = ((x <= 0 && y >= 0 && x >= (-1*this.param_r[0]) && y <= this.param_r[0])||(x >= 0 && y <= 0 && (y >= x - this.param_r[0]))||(x >= 0 && y >= 0 && (x * x + y * y <= this.param_r[0] * this.param_r[0])));
            // flagForColor=1;
